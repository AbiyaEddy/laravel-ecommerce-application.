...
class CreateAttributeValueProductAttributeTable extends Migration
{
    ...
    // QLSTATE[HY000]: General error: 1005 Can't create table `laravel_webapp`.`attribute_value_product_rectly formed") (SQL: alter table `attribute_value_product_attrib
    /**
